...
const translations = {
  en: {
    ...
    "review.listTitle": "Open PR / MR",
    "review.listHint": "Only open pull requests and merge requests are shown.",
    ...
    "review.loadingList": "Loading open PR / MR...",
    "review.listEmpty": "No open PR / MR found.",
  ...
  zh: {
    ...
    "review.listTitle": "开启中的 PR / MR",
    "review.listHint": "这里只展示开启中的 Pull Request / Merge Request。",
    ...
    "review.loadingList": "正在加载开启中的 PR / MR...",
    "review.listEmpty": "当前没有开启中的 PR / MR。",
